 ...
 */
@Controller
public class AppTvsZanController extends ControllerConstants {

    @Autowired
    @Qualifier("appTvZanService")
    ...
    @RequestMapping("/appVideoZanSaveTV")
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping(value = "/appVideosListZanTV", produces = "text/plain;charset=UTF-8")
    @ResponseBody
