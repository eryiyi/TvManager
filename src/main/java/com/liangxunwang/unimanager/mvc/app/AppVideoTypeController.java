 ...
 */
@Controller
public class AppVideoTypeController extends ControllerConstants {
    @Autowired
    @Qualifier("videoTypeObjService")
    private ListService videoTypeObjService;

    //列表
    @RequestMapping(value = "/getVideoTypes", produces = "text/plain;charset=UTF-8")
    @ResponseBody
    public String getVideoTypes(AdQuery query){
        try {
