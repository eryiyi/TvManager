...
public class ZanService implements SaveService, ListService {
    ...
    public Object save(Object object) throws ServiceException {
        ...
        EmpVO member = empDao.findById(zan.getEmpId());
        ...
        relate.setCont(member.getMm_emp_nickname() + " 赞了你的动态");
        relateDao.save(relate);

        EmpVO pushMember = empDao.findById(zan.getSendEmpId());
        ...
        pushZan(pushId, type, member.getMm_emp_nickname() + " 赞了你的动态");
        return zan;
    }
