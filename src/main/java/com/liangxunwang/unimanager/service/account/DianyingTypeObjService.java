...
import com.liangxunwang.unimanager.dao.DianyingTypeDao;
 ...
 */
@Service("dianyingTypeObjService")
public class DianyingTypeObjService implements ListService,SaveService ,ExecuteService, UpdateService{
    @Autowired
    @Qualifier("dianyingTypeDao")
    private DianyingTypeDao videoTypeDao;
