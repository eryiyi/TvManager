...
import com.liangxunwang.unimanager.dao.AppTvCommentDao;
 ...
 */
@Service("appTvCommentService")
public class AppTvCommentService implements SaveService, ListService {
    @Autowired
    @Qualifier("appTvCommentDao")
    private AppTvCommentDao appCommentDao;
