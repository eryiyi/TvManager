...
import com.liangxunwang.unimanager.dao.AppTvZanDao;
 ...
 */
@Service("appTvZanService")
public class AppTvZanService implements SaveService, ListService {
    private static Logger logger = LogManager.getLogger(AppTvZanService.class);
    @Autowired
    @Qualifier("appTvZanDao")
    private AppTvZanDao zanDao;
