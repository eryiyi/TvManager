...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
        <title>${record.mm_emp_nickname}${record.mm_msg_content}</title>
...
<div class="h clearfix">
    <img class="h1" src="${record.mm_emp_cover}"/>

    <div class="h2">
        <span class="h21">${record.mm_emp_nickname}</span>
        <span class="h22">${record.dateline}</span>
    </div>
</div>
<div class="m clearfix">
    <div class="m1">
        ${record.mm_msg_content}</div>
    <%--<c:if test="${record.recordVideo == null || record.recordVideo ==''}">--%>
        <c:if test="${record.mm_msg_picurl != null}">
            <div class="m2">
...
<a href="http://a.app.qq.com/o/simple.jsp?pkgname=com.Lbins.GuirenApp">
    <img class="download-button" src="/img/share_download.png" alt="下载大视界手机客户端">
</a>
