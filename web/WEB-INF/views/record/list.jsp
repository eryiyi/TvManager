        ...
        <table class="table">
          ...
          <c:forEach items="${list}" var="e" varStatus="st">
            <tr>
              ...
              <td>
                <c:if test="${e.mm_msg_type=='0'}">文字</c:if>
                <c:if test="${e.mm_msg_type=='1'}">图片</c:if>
              </td>
      ...
      $.ajax({
        ...
        success:function(_data){
          ...
          if(data.success){
            ...
            var mm_msg_type = $("#mm_msg_type").val();
            if(mm_msg_type == 0){
              window.location.href="#module=/record/listQiugou&page="+_index+"&size="+size+"&keyword="+keywords+ "&_t=" + new Date().getTime();
            }else{
              window.location.href="#module=/record/listGongying&page="+_index+"&size="+size+"&keyword="+keywords+ "&_t=" + new Date().getTime();
            }
          }else{
            var _case = {1:"删除失败"};
