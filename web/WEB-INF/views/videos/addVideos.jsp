            ...
            <div class="box-content">
                ...
                <form id="save_form" class="form-horizontal" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="paopao_title" class="form-control" placeholder="电影标题"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea id="paopao_content" class="form-control" placeholder="电影内容" data-toggle="tooltip"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea id="paopao_videourl" class="form-control" placeholder="电影路径" data-toggle="tooltip"
                                      data-placement="bottom" title="Tooltip for name"/>
                        </div>
                    </div>
