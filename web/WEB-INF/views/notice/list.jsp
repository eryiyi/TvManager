        ...
        <table class="table">
          ...
          <c:forEach items="${list}" var="e" varStatus="st">
            <tr>
              ...
              <td>${e.dateline}</td>
              <td>
                <a class="btn btn-default btn-sm" href="javascript:void (0)" onclick="editRole('${e.mm_notice_id}')" role="button">详情</a>
              </td>
            </tr>
          </c:forEach>
          </tbody>
...
<script type="text/javascript">
  function searchIndex(e){
    ...
    if(_index <= ${page.pageCount} && _index >= 1){
      window.location.href="#module=/noticeController/list&page="+page+"&size="+size;
    }else{
